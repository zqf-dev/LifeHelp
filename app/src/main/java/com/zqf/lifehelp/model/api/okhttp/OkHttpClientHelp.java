package com.zqf.lifehelp.model.api.okhttp;

import android.content.Context;
import android.text.TextUtils;

import com.zqf.lifehelp.app.App;
import com.zqf.lifehelp.model.api.Interceptor.LoggerInterceptor;
import com.zqf.lifehelp.model.api.Interceptor.Platform;
...
public class OkHttpClientHelp {
    ...
    public OkHttpClient getOkHttp() {
        OkHttpClient mOkHttpClient = new OkHttpClient().newBuilder()
                ...
                .addInterceptor(new LoggerInterceptor("TAG"))//打印的日志
                .build();
